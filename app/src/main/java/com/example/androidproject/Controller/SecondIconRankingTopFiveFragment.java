 ...
 * Use the {@link SecondIconRankingTopFiveFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SecondIconRankingTopFiveFragment extends Fragment {
    ...
    public SecondIconRankingTopFiveFragment() {
     ...
     * @return A new instance of fragment SecondIconRankingTopFiveFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SecondIconRankingTopFiveFragment newInstance(String param1, String param2) {
        SecondIconRankingTopFiveFragment fragment = new SecondIconRankingTopFiveFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_second_icon_ranking_top_five, container, false);
    }
    ...
    public void initView(View view)
    {
        ...
        imageViewTop1 = view.findViewById(R.id.second_imageViewTop1);
        imageViewTop2 = view.findViewById(R.id.second_imageViewTop2);
        imageViewTop3 = view.findViewById(R.id.second_imageViewTop3);
        imageViewTop4 = view.findViewById(R.id.second_imageViewTop4);
        imageViewTop5 = view.findViewById(R.id.second_imageViewTop5);
        ...
        tvTop1Name = view.findViewById(R.id.second_textViewTop1_IconName);
        tvTop2Name = view.findViewById(R.id.second_textViewTop2_IconName);
        tvTop3Name = view.findViewById(R.id.second_textViewTop3_IconName);
        tvTop4Name = view.findViewById(R.id.second_textViewTop4_IconName);
        tvTop5Name = view.findViewById(R.id.second_textViewTop5_IconName);
        ...
        tvTop1Count = view.findViewById(R.id.second_textViewTop1Count);
        tvTop2Count = view.findViewById(R.id.second_textViewTop2Count);
        tvTop3Count = view.findViewById(R.id.second_textViewTop3Count);
        tvTop4Count = view.findViewById(R.id.second_textViewTop4Count);
        tvTop5Count = view.findViewById(R.id.second_textViewTop5Count);
