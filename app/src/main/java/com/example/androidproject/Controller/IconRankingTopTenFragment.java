 ...
 * Use the {@link IconRankingTopTenFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IconRankingTopTenFragment extends Fragment {
    ...
    public IconRankingTopTenFragment() {
     ...
     * @return A new instance of fragment IconRankingSecondFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static IconRankingTopTenFragment newInstance(String param1, String param2) {
        IconRankingTopTenFragment fragment = new IconRankingTopTenFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_icon_ranking_top_ten, container, false);
    }
    ...
    public void initView(View view)
    {
        ...
        imageViewTop6 = view.findViewById(R.id.imageViewTop6);
        imageViewTop7 = view.findViewById(R.id.imageViewTop7);
        imageViewTop8 = view.findViewById(R.id.imageViewTop8);
        imageViewTop9 = view.findViewById(R.id.imageViewTop9);
        imageViewTop10 = view.findViewById(R.id.imageViewTop10);
        ...
        tvTop6Name = view.findViewById(R.id.textViewTop6_IconName);
        tvTop7Name = view.findViewById(R.id.textViewTop7_IconName);
        tvTop8Name = view.findViewById(R.id.textViewTop8_IconName);
        tvTop9Name = view.findViewById(R.id.textViewTop9_IconName);
        tvTop10Name = view.findViewById(R.id.textViewTop10_IconName);
        ...
        tvTop6Count = view.findViewById(R.id.textViewTop6Count);
        tvTop7Count = view.findViewById(R.id.textViewTop7Count);
        tvTop8Count = view.findViewById(R.id.textViewTop8Count);
        tvTop9Count = view.findViewById(R.id.textViewTop9Count);
        tvTop10Count = view.findViewById(R.id.textViewTop10Count);
